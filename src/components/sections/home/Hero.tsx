...
const DEFAULT_HERO = {
  ...
  description:
    'Transform your workflow with AI-driven insights, automated processes, and real-time analytics. Built for modern teams who demand efficiency.',
  features: [
